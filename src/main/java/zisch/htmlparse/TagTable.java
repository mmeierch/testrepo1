...
final class TagTable {
  ...
  private static final Dict[] TAGS = {
          new Dict("html", Dict.VERS_ALL, (Dict.CM_HTML | Dict.CM_OPT | Dict.CM_OMITST), ParserImpl.HTML,
                  TagCheckImpl.HTML),
          ...
          new Dict("style", (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC), Dict.CM_HEAD, ParserImpl.SCRIPT,
                  TagCheckImpl.STYLE),
          new Dict("script", (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC), (Dict.CM_HEAD | Dict.CM_MIXED
                  | Dict.CM_BLOCK | Dict.CM_INLINE), ParserImpl.SCRIPT, TagCheckImpl.SCRIPT),
          ...
          new Dict("hr", (short) (Dict.VERS_ALL & ~Dict.VERS_BASIC), (Dict.CM_BLOCK | Dict.CM_EMPTY), ParserImpl.EMPTY,
                  TagCheckImpl.HR),
          ...
          new Dict("nolayer", Dict.VERS_NETSCAPE, (Dict.CM_BLOCK | Dict.CM_INLINE | Dict.CM_MIXED), ParserImpl.BLOCK,
                  null),
          ...
          new Dict("ins", (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC),
                  (Dict.CM_INLINE | Dict.CM_BLOCK | Dict.CM_MIXED), ParserImpl.INLINE, null),
          new Dict("del", (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC),
                  (Dict.CM_INLINE | Dict.CM_BLOCK | Dict.CM_MIXED), ParserImpl.INLINE, null),
          ...
          new Dict("thead", (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC),
                  (Dict.CM_TABLE | Dict.CM_ROWGRP | Dict.CM_OPT), ParserImpl.ROWGROUP, null),
          new Dict("tfoot", (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC),
                  (Dict.CM_TABLE | Dict.CM_ROWGRP | Dict.CM_OPT), ParserImpl.ROWGROUP, null),
          new Dict("tbody", (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC),
                  (Dict.CM_TABLE | Dict.CM_ROWGRP | Dict.CM_OPT), ParserImpl.ROWGROUP, null),
          new Dict("tr", Dict.VERS_FROM32, (Dict.CM_TABLE | Dict.CM_OPT), ParserImpl.ROW, null),
          new Dict("td", Dict.VERS_FROM32, (Dict.CM_ROW | Dict.CM_OPT | Dict.CM_NO_INDENT), ParserImpl.BLOCK,
                  TagCheckImpl.TABLECELL),
          new Dict("th", Dict.VERS_FROM32, (Dict.CM_ROW | Dict.CM_OPT | Dict.CM_NO_INDENT), ParserImpl.BLOCK,
                  TagCheckImpl.TABLECELL),
          ...
          new Dict("img", Dict.VERS_ALL, (Dict.CM_INLINE | Dict.CM_IMG | Dict.CM_EMPTY), ParserImpl.EMPTY,
                  TagCheckImpl.IMG),
          new Dict("object", Dict.VERS_HTML40,
                  (Dict.CM_OBJECT | Dict.CM_HEAD | Dict.CM_IMG | Dict.CM_INLINE | Dict.CM_PARAM), ParserImpl.BLOCK,
                  null),
          ...
          new Dict("noscript", (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC),
                  (Dict.CM_BLOCK | Dict.CM_INLINE | Dict.CM_MIXED), ParserImpl.BLOCK, null),
          ...
          new Dict("nolayer", Dict.VERS_NETSCAPE, (Dict.CM_BLOCK | Dict.CM_INLINE | Dict.CM_MIXED), ParserImpl.BLOCK,
                  null),
          new Dict("ilayer", Dict.VERS_NETSCAPE, Dict.CM_INLINE, ParserImpl.INLINE, null),
          new Dict("map", (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC), Dict.CM_INLINE, ParserImpl.BLOCK,
                  TagCheckImpl.MAP),
          new Dict("area", (short) (Dict.VERS_ALL & ~Dict.VERS_BASIC), (Dict.CM_BLOCK | Dict.CM_EMPTY),
                  ParserImpl.EMPTY, TagCheckImpl.AREA),
          ...
          new Dict("optgroup", (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC), (Dict.CM_FIELD | Dict.CM_OPT),
                  ParserImpl.OPTGROUP, null),
  ...
  boolean isAnchorElement (Node node) {
    return node.tag == this.tagA || node.tag == this.tagApplet || node.tag == this.tagForm || node.tag == this.tagFrame
            || node.tag == this.tagIframe || node.tag == this.tagImg || node.tag == this.tagMap;
  }
        ...
        switch (tagType) {
          ...
          case Dict.TAGTYPE_EMPTY:
            if ((curDictEntry.versions == Dict.VERS_PROPRIETARY)
                    && ((curDictEntry.model & Dict.CM_EMPTY) == Dict.CM_EMPTY) && // (curDictEntry.parser == ParseBlock)
                                                                                  // &&
                    (curDictEntry != tagWbr)) {
          ...
          case Dict.TAGTYPE_INLINE:
            if ((curDictEntry.versions == Dict.VERS_PROPRIETARY)
                    && ((curDictEntry.model & Dict.CM_INLINE) == Dict.CM_INLINE) && // (curDictEntry.parser ==
                                                                                    // ParseInline) &&
                    (curDictEntry != tagBlink) && (curDictEntry != tagNobr) && (curDictEntry != tagWbr)) {
              tagNames.add(curDictEntry.name);
            }
            break;

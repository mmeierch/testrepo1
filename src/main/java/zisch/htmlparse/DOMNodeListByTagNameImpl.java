...
/**
 * DOMNodeListByTagNameImpl. The items in the <code>NodeList</code> are accessible via an integral index, starting from
 * 0.
 * 
 ...
 * @author Zisch
 */
final class DOMNodeListByTagNameImpl implements org.w3c.dom.NodeList {

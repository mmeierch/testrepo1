...
final class DOMDocumentImpl extends DOMNodeImpl implements org.w3c.dom.Document {
   ...
   * @param namespaceUri the namespace URI for all elements of this document (may be {@code null} for no namespace)
   */
  protected DOMDocumentImpl (final Node adaptee, final String namespaceUri) {
    super(adaptee);

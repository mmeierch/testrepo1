...
public final class AttrCheckImpl {
  ...
  public static class CheckUrl implements AttrCheck {
     ...
     */
    public void check (Lexer lexer, Node node, AttVal attval) throws SAXException {
      char c;
      StringBuffer dest;
  ...
  public static class CheckValign implements AttrCheck {
     ...
     */
    private static final String[] VALID_VALUES_PROPRIETARY = new String[] { "texttop", "absmiddle", "absbottom",
            "textbottom" };

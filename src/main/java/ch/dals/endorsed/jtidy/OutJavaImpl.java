...
public class OutJavaImpl implements Out
{
    ...
    /**
     * @see ch.dals.endorsed.jtidy.Out#outc(int)
     */
    ...
    /**
     * @see ch.dals.endorsed.jtidy.Out#outc(byte)
     */
    ...
    /**
     * @see ch.dals.endorsed.jtidy.Out#newline()
     */
    public void newline()
    {
        try
    ...
    /**
     * @see ch.dals.endorsed.jtidy.Out#flush()
     */
    public void flush()
    {
        try

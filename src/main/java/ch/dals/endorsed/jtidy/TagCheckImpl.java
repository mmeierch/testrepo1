...
public final class TagCheckImpl {
  ...
  public static class CheckHTML implements TagCheck {
    ...
    /**
     * @see ch.dals.endorsed.jtidy.TagCheck#check(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node)
     */
    public void check (Lexer lexer, Node node) throws SAXException {

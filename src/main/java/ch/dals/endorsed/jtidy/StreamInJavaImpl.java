...
public class StreamInJavaImpl implements StreamIn
{
    ...
    /**
     * @see ch.dals.endorsed.jtidy.StreamIn#readCharFromStream()
     */
    ...
    /**
     * @see ch.dals.endorsed.jtidy.StreamIn#readChar()
     */
    public int readChar()
    {
        int c;
    ...
    /**
     * @see ch.dals.endorsed.jtidy.StreamIn#ungetChar(int)
     */
    ...
    /**
     * @see ch.dals.endorsed.jtidy.StreamIn#isEndOfStream()
     */
    ...
    /**
     * @see ch.dals.endorsed.jtidy.StreamIn#setLexer(ch.dals.endorsed.jtidy.Lexer)
     */

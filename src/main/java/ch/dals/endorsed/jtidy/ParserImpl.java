...
public final class ParserImpl {
   ...
   */
  protected static void parseTag (Lexer lexer, Node node, short mode) throws SAXException {
   ...
   * @throws SAXException in case of errors
   */
  protected static void moveToHead (Lexer lexer, Node element, Node node) throws SAXException {
    Node head;
  ...
  public static class ParseHTML implements Parser {
    ...
    /**
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node html, short mode) throws SAXException {
      Node node, head;
      Node frameset = null;
      Node noframes = null;
  ...
  public static class ParseHead implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node head, short mode) throws SAXException {
      Node node;
      int hasTitle = 0;
      int hasBase = 0;
      TagTable tt = lexer.configuration.tt;
  ...
  public static class ParseTitle implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node title, short mode) throws SAXException {
      Node node;
  ...
  public static class ParseScript implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node script, short mode) throws SAXException {
      ...
      node = lexer.getToken(Lexer.IGNORE_WHITESPACE);
      if (!(node != null && node.type == Node.END_TAG && node.tag != null && node.tag.name
              .equalsIgnoreCase(script.tag.name))) {
  ...
  public static class ParseBody implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node body, short mode) throws SAXException {
      Node node;
      ...
      while ((node = lexer.getToken(mode)) != null) {
        ...
        if (node.type == Node.TEXT_NODE && node.end <= node.start + 1 && node.textarray[node.start] == (byte) ' ') {
          iswhitenode = true;
        }
  ...
  public static class ParseFrameSet implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node frameset, short mode) throws SAXException {
      Node node;
      TagTable tt = lexer.configuration.tt;
  ...
  public static class ParseInline implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node element, short mode) throws SAXException {
      Node node, parent;
      TagTable tt = lexer.configuration.tt;
      ...
      while ((node = lexer.getToken(mode)) != null) {
        ...
        if (node.type == Node.START_TAG && node.tag == element.tag && lexer.isPushed(node) && !node.implicit
                && !element.implicit && node.tag != null && ((node.tag.model & Dict.CM_INLINE) != 0)
                && node.tag != tt.tagA && node.tag != tt.tagFont && node.tag != tt.tagBig && node.tag != tt.tagSmall
                && node.tag != tt.tagQ) {
  ...
  public static class ParseList implements Parser {
    ...
    public void parse (Lexer lexer, Node list, short mode) throws SAXException {
      Node node;
      Node parent;
      TagTable tt = lexer.configuration.tt;
  ...
  public static class ParsePre implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node pre, short mode) throws SAXException {
      Node node;
      TagTable tt = lexer.configuration.tt;
  ...
  public static class ParseBlock implements Parser {
    ...
    public void parse (Lexer lexer, Node element, short mode) throws SAXException {
      ...
      while ((node = lexer.getToken(mode)) != null) {
        ...
        if (node.type == Node.END_TAG && node.tag != null && (node.tag == element.tag || element.was == node.tag)) {
        ...
        if (node.type == Node.TEXT_NODE) {
          ...
          if (node.type == Node.TEXT_NODE && node.end <= node.start + 1 && lexer.lexbuf[node.start] == (byte) ' ') {
            iswhitenode = true;
          }
          ...
          if (element.tag == tt.tagBody || element.tag == tt.tagMap || element.tag == tt.tagBlockquote
                  || element.tag == tt.tagForm || element.tag == tt.tagNoscript) {
            lexer.constrainVersion(~Dict.VERS_HTML40_STRICT);
          }
          continue;
        }
  ...
  public static class ParseTableTag implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node table, short mode) throws SAXException {
      Node node, parent;
      int istackbase;
      TagTable tt = lexer.configuration.tt;
  ...
  public static class ParseColGroup implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node colgroup, short mode) throws SAXException {
      Node node, parent;
      TagTable tt = lexer.configuration.tt;
  ...
  public static class ParseRowGroup implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node rowgroup, short mode) throws SAXException {
      Node node, parent;
      TagTable tt = lexer.configuration.tt;
      ...
      while ((node = lexer.getToken(Lexer.IGNORE_WHITESPACE)) != null) {
        ...
        if (node.type == Node.END_TAG) {
          ...
          if (node.tag == tt.tagForm || (node.tag != null && (node.tag.model & (Dict.CM_BLOCK | Dict.CM_INLINE)) != 0)) {
            if (node.tag == tt.tagForm) {
              badForm(lexer);
            }
            lexer.report.warning(lexer, rowgroup, node, Report.DISCARDING_UNEXPECTED);
  ...
  public static class ParseRow implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node row, short mode) throws SAXException {
      Node node, parent;
  ...
  public static class ParseNoFrames implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node noframes, short mode) throws SAXException {
      Node node;
      TagTable tt = lexer.configuration.tt;
  ...
  public static class ParseSelect implements Parser {
     ...
     * @see ch.dals.endorsed.jtidy.Parser#parse(ch.dals.endorsed.jtidy.Lexer, ch.dals.endorsed.jtidy.Node, short)
     */
    public void parse (Lexer lexer, Node field, short mode) throws SAXException {
      Node node;
      TagTable tt = lexer.configuration.tt;
  ...
  public static class ParseText implements Parser {
    ...
    public void parse (Lexer lexer, Node field, short mode) throws SAXException {
      ...
      while ((node = lexer.getToken(mode)) != null) {
        ...
        if (node.tag != null && ((node.tag.model & Dict.CM_INLINE) != 0) && (node.tag.model & Dict.CM_FIELD) == 0) // #487283
        // -
        // fix
        // by
        // Lee
   ...
   */
  public static Node parseDocument (final Lexer lexer) throws SAXException {
  ...
  /**
   * Indicates whether or not whitespace should be preserved for this element. If an <code>xml:space</code> attribute is
   * found, then if the attribute value is <code>preserve</code>, returns <code>true</code>. For any other value,
   * returns <code>false</code>. If an <code>xml:space</code> attribute was <em>not</em> found, then the following
   * element names result in a return value of <code>true:
   *  pre, script, style,</code> and <code>xsl:text</code>. Finally, if a <code>TagTable</code> was passed in and the
   * element appears as the "pre" element in the <code>TagTable</code>, then <code>true</code> will be returned.
  ...
  public static boolean XMLPreserveWhiteSpace (Node element, TagTable tt) {
    ...
    if ("pre".equalsIgnoreCase(element.element) || "script".equalsIgnoreCase(element.element)
   ...
   * XML documents.
   */
  public static void parseXMLElement (Lexer lexer, Node element, short mode) throws SAXException {
    Node node;
  ...
  public static Node parseXMLDocument (Lexer lexer) throws SAXException {
